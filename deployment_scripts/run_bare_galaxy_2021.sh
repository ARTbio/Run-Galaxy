...
cd ~/galaxy && wget https://storage.googleapis.com/analyse-genome-coupon-1/bare.client.tar.gz \
                    https://storage.googleapis.com/analyse-genome-coupon-1/bare.static.tar.gz
